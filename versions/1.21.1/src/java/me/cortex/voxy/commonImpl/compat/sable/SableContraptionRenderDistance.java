...
public final class SableContraptionRenderDistance {
    private static final Path CONFIG_PATH = VoxyCommon.getPlatformUtil().getConfigDir().resolve("voxy-config.json");
    private static final Path SABLE_COMMON_CONFIG_PATH = VoxyCommon.getPlatformUtil().getConfigDir().resolve("sable-common.toml");
